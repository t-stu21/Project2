$(document).ready(function() {
  ...
  function createUserRow(userData) {
    ...
    if (userData.WorkoutDays) {
      newTr.append('<td> ' + userData.WorkoutDays.length + '</td>');
    } else {
      newTr.append('<td>0</td>');
    }
    newTr.append("<td><a href='/workoutday?user_id=" + userData.id + "'>Go to WorkoutDays</a></td>");
    newTr.append("<td><a href='/addworkout?user_id=" + userData.id + "'>Create a WorkoutDay</a></td>");
  ...
  function renderEmpty() {
    ...
    alertDiv.text('You must create an User before you can create a WorkoutDay.');
